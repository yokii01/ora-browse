...
export type ActionType = 'navigate' | 'click' | 'dblclick' | 'rightclick' | 'type' | 'fill' | 'press' | 'scroll' | 'scrollIntoView' | 'hover' | 'select' | 'deselect' | 'check' | 'uncheck' | 'wait' | 'waitForLoad' | 'waitForNetwork' | 'waitForSelector' | 'waitForText' | 'waitForNavigation' | 'extract' | 'screenshot' | 'fullPageScreenshot' | 'elementScreenshot' | 'upload' | 'download' | 'switch_tab' | 'new_tab' | 'close_tab' | 'close_other_tabs' | 'go_back' | 'go_forward' | 'refresh' | 'stop' | 'evaluate' | 'injectScript' | 'setCookie' | 'deleteCookie' | 'clearCookies' | 'getCookies' | 'setLocalStorage' | 'getSessionStorage' | 'clearLocalStorage' | 'clearSessionStorage' | 'dragAndDrop' | 'focus' | 'blur' | 'selectText' | 'copyToClipboard' | 'pasteFromClipboard' | 'printToPdf' | 'emulateDevice' | 'emulateTimezone' | 'emulateLocale' | 'emulateGeolocation' | 'emulatePermissions' | 'setOffline' | 'setCacheEnabled' | 'setJavaScriptEnabled' | 'setUserAgent' | 'setExtraHttpHeaders' | 'authenticate' | 'interceptRequest' | 'mockResponse' | 'throttleNetwork' | 'throttleCPU' | 'startTracing' | 'stopTracing' | 'startRecording' | 'stopRecording' | 'highlightElement' | 'flashElement' | 'markElement' | 'compareScreenshots' | 'visualRegression' | 'accessibilityScan' | 'performanceMetrics' | 'lighthouseAudit' | 'seoAudit' | 'securityAudit';
...
export type TaskStatus = 'pending' | 'planning' | 'running' | 'paused' | 'resuming' | 'completed' | 'failed' | 'cancelled' | 'timeout' | 'blocked';
...
export type WorkflowCategory = 'data_extraction' | 'form_filling' | 'testing' | 'monitoring' | 'research' | 'ecommerce' | 'social_media' | 'automation' | 'custom';
...
export type EventType = 'task_started' | 'planning_started' | 'planning_completed' | 'browser_started' | 'browser_ready' | 'page_loaded' | 'page_navigation' | 'observing' | 'observation_completed' | 'thinking' | 'reasoning_completed' | 'action_planned' | 'action_started' | 'action_completed' | 'action_failed' | 'verification_started' | 'verification_completed' | 'retrying' | 'retry_exhausted' | 'task_completed' | 'task_failed' | 'task_paused' | 'task_resumed' | 'task_cancelled' | 'workflow_started' | 'workflow_step' | 'workflow_completed' | 'workflow_failed' | 'session_created' | 'session_closed' | 'session_error' | 'error' | 'warning' | 'progress' | 'log';
...
//# sourceMappingURL=types-v2.d.ts.map